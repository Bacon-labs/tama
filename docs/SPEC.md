...
Proof skeletons may contain explicit `sorry` TODOs tied to public obligations and
fuzz-shaped Foundry mirrors. They are acceptable for local scaffolding, but
`tama audit trust-boundary` must reject them before release.
